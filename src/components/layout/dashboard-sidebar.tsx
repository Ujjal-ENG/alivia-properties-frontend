    ...
    <aside className={wrapperClass}>
      <div className={innerClass}>
        ...
        <div className="relative overflow-hidden rounded-[1.5rem] bg-brand-aurora p-4">
          <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gold-200/40 blur-2xl" aria-hidden />
          <div className="relative flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-sm font-semibold text-ink-900">{roleLabel}</p>
            </div>
          </div>
        </div>

        {/* Navigation */}
        <nav className="mt-3 flex-1 space-y-4 overflow-y-auto px-1 pb-2 [scrollbar-width:thin]">
          {groups.map((group) => (
