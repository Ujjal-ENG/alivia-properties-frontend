    ...
    <main className="bg-linear-to-b from-brand-50/60 via-white to-white">
      <div className="container-page section-y-sm">
        <nav className="mb-6 flex items-center gap-2 text-sm text-ink-600">
          <Link href={ROUTES.MARKETPLACE} className="hover:text-brand-700">
            Marketplace
          </Link>
          <span>›</span>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr] lg:items-start">
          <section className="rounded-[2rem] border border-border/70 bg-white p-5 shadow-(--shadow-card) sm:p-7">
            ...
            {tree.length === 0 ? (
              <div className="rounded-2xl border border-dashed border-border py-16 text-center text-sm text-ink-500">
                ...
                <a href="tel:+8801700000000" className="font-medium text-brand-700">
          ...
          <aside className="space-y-4 lg:sticky lg:top-24">
            ...
            <div className="rounded-[2rem] border border-border/70 bg-brand-50/60 p-5">
